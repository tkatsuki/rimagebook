...
display(hft, "Original image")
hftb <- E2b(hft)
hftfft <- imgFFT(hftb)
hftspec <- imgFFTSpectrum(hftfft)
hfts <- b2E(hftspec)
display(hfts, "FFT spectrum of the original image")
...
display(hftresspece, "Masked spectrum")
nonhalftone <- imgFFTInv(hftres)
display(normalize(b2E(nonhalftone)), "Smoothed image")
